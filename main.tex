...
\includegraphics[height=4cm]{images/cava-bien} & \includegraphics[height=4cm]{images/suslik} & \includegraphics[height=4cm]{images/sobachevich}             \\
 Сова Бьен    &  Сусленский суслик        &   Господин Собакевич            \\
   &  & \\
            &          &              \\
\includegraphics[height=4cm]{images/cosmoroom} & \includegraphics[height=4cm]{images/cave-stories} & \includegraphics[height=4cm]{images/razukrashki.jpg}             \\
 Окно в космос       &  Волшебная пещера    &     Разукрашки \\    
        &      &     Дваукрашки \\
        &      &     Триукрашки \\
\end{tabular}
\end{table}
