...
\say{Это молдавские ласточки прилетели из далекого севера. Радуются что нашли место где чувствуют себя почти как дома} -- вдруг прервал завораживающее представление голос Секретаря, который тоже наблюдал за происходящим.
...
\say{Да, именно так! Я птица секретарь, слежу за всем что происходит в нашей местности. Веду перепись населения, учёт ресурсов, координирую туристов, документирую потоки мигрантов, и так далее. Ты кстати, кто, что тебя сюда привело и как ты здесь оказалась?}

\say{Я зебра, пришла пешком из саванны, шла вдоль реки, пока не дошла до этого места. Сюда меня привели любопытство и зов приключений}.

\say{Аха, записал}, сказал секретарь важным голосом, хотя не было видно чтобы он что-то где-то записывал. \say{Я пишу всё в память - она у меня лучше чем у слона, поэтому меня и зовут Секретарь}, добавил на всякий случай секретарь.

\say{В округе меня называют ``Хвостуном'', потому что у меня красивый хвост}.

\say{А может Хвастуном, потому что ты хвастаешся?}, спросила зебра.

\say{Хмммм\ldots} подумал секретарь, не подавая вид что его что-то тревожит.
...
\say{Мы почти как бременские музыканты, только нас двое, и живём мы в Африке. Я однажды встретил их в поезде, когда ехал в Киль, это чуть севернее Га\ldots}, сказал незакночив мысль секретарь. Время продолжало лететь, они так хорошо разговорились, что не заметели как заблудились.
%Да, я бы с удовольствием покушала бы немного кильки.

Они оказались в неизвестном месте -- секретарь тут никогда не бывал, да и зебра о сих местах в рассказах бабушек ничего не слышала. \say{Не узнаю этот вид травы, листья этих кустов мне не знакомы}, подумала вслух зебра. Секретарь посмотрел по сторонам, было уже темно.

\say{Ну\ldots теперь мы влипли!} сказала зебра вздохнув.

Секретарь был с ней согласен, но пока ничего не говорил. Он думал. Зебра расстроилась, опустив голову - \say{Ох, что нам теперь делать?!}. \say{Не грусти, мы подумаем и найдем решение}, сказал секретарь, хотя решения у него не было.

Печаль зебры росла, она опустила глаза, а секретарь продолжал разговаривать, предлагал идеи -- \say{попробуем то\ldots попробуем это\ldots, может так\ldots а как насчёт этого\ldots может мы найдем какой-то дорожный знак, карту или другой след цивилизации?\ldots}

Зебра смотрела отчаяно на землю под ногами. \say{След! Точно!} воскликнула она громким голосом.

\begin{figure}[h]
	\centering
	\includegraphics[width=0.3\columnwidth]{images/hoofprints.jpeg}
...
\say{Хоть он и хвастун, но добрый, и с ним весело и интересно}, подумала зебра ложась на траву.

\say{Мы хорошо поработали в команде}, подумал в ответ секретарь.

\say{Кем мы будем? Компаньонами? Напарниками?}, спросил секретарь.

\say{Давай ``Искателями приключений''}, зевая ответила зебра.
