...
\begin{table}[h]
	\begin{tabular}{ccc}
		...
		%\includegraphics[height=4cm]{images/tree-guide/willow-tree} & \includegraphics[height=4cm]{images/tree-guide/willow-tree} & \includegraphics[height=4cm]{images/tree-guide/willow-tree} \\		
